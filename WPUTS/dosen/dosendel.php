<?php
$iddosen = $_GET["p1"];
$sql = "SELECT tu.nama, tu.nidn, tu.gelar, tu.dapartemen FROM tbmhs tu WHERE tu.iddosen='$iddosen';";
$hasil = mysqli_query($cnn, $sql);
if (mysqli_num_rows($hasil) > 0) {
    $h = mysqli_fetch_assoc($hasil);
?>
    <h3>Hapus Data Dosen <?= $h["nama"] ?></h3>
    <form method="POST" action="datadosen.php">
        ...
        <div class="form-floating mb-3">
            <input type="number" name="txNIDN" class="form-control" id="floatingInput" placeholder="Masukan NIDN" value="<?= $h["nidn"] ?>">
